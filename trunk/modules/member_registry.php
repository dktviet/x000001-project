			...
			<table align="center" border="1" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center">
						...
						<br><br>
						[ <a href="./?frame=login"><?=$_lang=='vn'?'Đăng nhập':'Login'?></a> ]
						<br><br><br>
					</td>
				</tr>
			</table>
...
<table border="0" cellspacing="5" cellpadding="0" width="100%" align="center">
	...
	<tr><td height="20" colspan="3" class="normalTitle" align="left"><b><?=$l_PerInfo?></b><HR size="1" noshade></td></tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Name?></td>
		<td><font color="#FF0000">*</font></td>
		<td align="left"><input class="textbox" size="30" name="txtName" value="<?=$name?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont" width="35%"><?=$l_Sex?></td>
		<td width="7"><font color="#FF0000">*</font></td>
		<td align="left"><?=comboSex($sex,$_lang)?></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Company?></td>
		<td>&nbsp;</td>
		<td align="left"><input class="textbox" size="30" name="txtCompany" value="<?=$company?>"></td>
	</tr>


	<tr><td height="20" colspan="3" class="normalTitle" align="left"><b><?=$l_AddressInfo?></b><HR size="1" noshade></td></tr>


	<tr>
		<td align="right" class="normalFont"><?=$l_Address?></td>
		<td><font color="#FF0000">*</font></td>
		<td align="left"><input class="textbox" size="30" name="txtAddress" value="<?=$address?>"></td>
	</tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_State?></td>
		<td><font color="#FF0000">*</font></td>
		<td align="left"><input class="textbox" size="30" name="txtCity" value="<?=$city?>"></td>
	</tr>
	...
	<tr><td height="20" colspan="3" class="normalTitle" align="left"><b><?=$l_ContactInfo?></b><HR size="1" noshade></td></tr>

	<tr>
		<td align="right" class="normalFont"><?=$l_Tel?></td>
		<td><font color="#FF0000">*</font></td>
		<td align="left"><input class="textbox" size="30" name="txtTel" value="<?=$tel?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Fax?></td>
		<td>&nbsp;</td>
		<td align="left"><input class="textbox" size="30" name="txtFax" value="<?=$fax?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Email?></td>
		<td><font color="#FF0000">*</font></td>
		<td align="left"><input class="textbox" size="30" name="txtEmail" value="<?=$email?>"></td>
	</tr>
	
	<tr>
		<td align="right" class="normalFont"><?=$l_Website?></td>
		<td>&nbsp;</td>
		<td align="left"><input class="textbox" size="30" name="txtWebsite" value="<?=$website?>"></td>
	</tr>

	<tr><td height="20" colspan="3" class="normalTitle" align="left"><b><?=$l_UserInfo?></b><HR size="1" noshade></td></tr>
	...
	<tr>
		...
		<td align="left">
			...
			<font color="#3D3D3D">(<?=$l_min4char?>)</font>
		</td>
	</tr>
	...
	<tr><td height="20" colspan="3" class="normalTitle" align="left"><b><?=$l_strConfirm?></b><HR size="1" noshade></td></tr>
