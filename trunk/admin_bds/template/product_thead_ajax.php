...
<th width="120" class="title">
    <a class="title" href="<?=getLinkSort(4)?>">Mô tả</a>
    <br>
    <a class="title" href="<?=getLinkSort(5)?>">Chi tiết</a>
    <br>
...
<th width="80" class="title">
    <a class="title" href="<?=getLinkSort(8)?>">Giá sp</a>
    <br>
    <a class="title" href="<?=getLinkSort(8)?>">Lượt xem</a>
</th>
<th width="60" class="title"><a class="title" href="<?=getLinkSort(9)?>">Sắp xếp</a></th>
