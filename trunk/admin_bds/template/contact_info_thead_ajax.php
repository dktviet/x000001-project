...
<th width="152" class="title"><a class="title" href="<?=getLinkSort(2)?>">Tên hỗ trợ</a></th>
<th width="100" class="title"><a class="title" href="<?=getLinkSort(3)?>">Danh mục</a></th>
<th width="100" class="title"><a class="title" href="<?=getLinkSort(6)?>">Địa chỉ</a></th>
