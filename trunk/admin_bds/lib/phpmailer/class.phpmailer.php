...
class PHPMailer {
	...
	/**
	 * Holds the most recent send error message.
	 * @var string
	 */
	public $ErrorInfo = '';
	...
	/**
	 * Adds a "Cc" address.
	 * Note: this function works with the SMTP send on win32, not with the "mail" send.
	 * @param string $address
	 * @param string $name
	 * @return boolean true on success, false if address already used
	 */
	...
	public function Send() {
		try {
			...
			// Choose the send and send through it
			switch ($this->Mailer) {
				case 'sendmail' :
